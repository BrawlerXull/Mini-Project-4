...
def signup():
    ...
    heading2=Label(root,text="USER SIGNUP",font=("Helvetica", 25),bg="#AD53A6",fg="white")
...
def login():
    ...
    global login_btn,option,goto_signup,signup_btn,heading1

    heading1=Label(root,text="USER LOGIN",font=("Helvetica", 25),bg="#AD53A6",fg="white")
